...
#include <fstream> // Necessary for loading files, for example, shaders
...
VkShaderModule HelloTriangleApplication::createShaderModule(const std::vector<char>& code)
{
    ...
    if (vkCreateShaderModule(m_device, &createInfo,
...
void HelloTriangleApplication::createSyncObjects()
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        if (vkCreateSemaphore(m_device, &semaphoreInfo,
                              nullptr, &m_imageAvailableSemaphores[i]) != VK_SUCCESS ||
            vkCreateSemaphore(m_device, &semaphoreInfo,
                              nullptr, &m_renderFinishedSemaphores[i]) != VK_SUCCESS ||
            vkCreateFence(m_device, &fenceInfo,
                  ...
                  VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
    ...
    if (vkAllocateMemory(m_device, &allocInfo,
...
void HelloTriangleApplication::createCommandPool()
{
    ...
    if (vkCreateCommandPool(m_device, &commandPoolInfo,
    ...
    if (vkCreateCommandPool(m_device, &transferPoolInfo,
                            nullptr, &m_transferCommandPool) != VK_SUCCESS) {
...
void HelloTriangleApplication::createUniformBuffers()
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        vkMapMemory(m_device, m_uniformBuffersMemory[i],
                    0, bufferSize, 0, &m_uniformBuffersMapped[i]);
    }
}
...
void HelloTriangleApplication::createDescriptorPool()
{
    ...
    if (vkCreateDescriptorPool(m_device, &poolInfo,
...
void HelloTriangleApplication::createDescriptorSets()
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        vkUpdateDescriptorSets(m_device, 1,
...
void HelloTriangleApplication::createImageViews()
{
    ...
    for (size_t i = 0; i < m_swapChainImages.size(); i++) {
        ...
        if (vkCreateImageView(m_device, &createInfo,
...
void HelloTriangleApplication::pickPhysicalDevise()
{
...
void HelloTriangleApplication::drawFrame()
{
    ...
    if (vkQueueSubmit(m_graphicsQueue, 1,
...
{
    if (glfwCreateWindowSurface(m_instance, m_window,
...
void HelloTriangleApplication::createSwapChain()
{
    ...
    if (vkCreateSwapchainKHR(m_device, &createInfo,
...
[[nodiscard]] std::vector<const char*> HelloTriangleApplication::getRequiredExtension() const
{
